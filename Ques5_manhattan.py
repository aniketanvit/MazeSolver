...
def search_algo_astar(maze,sx,sy,gx,gy,count):
    open = []
    count = 0
    closed = []
    parent = {}
...
def main():
    ...
    for i in prob:
        ...
        for j in range(1,10):
            ...
            len1 = search_algo_astar(maze, 0,0,100,100,count)
            print(maze)
            if maze[99][99] == 5:
                res.append(len1)
                count1 =+ 1  
...
#     plt.ylabel("Average length of the path generated from Start to Goal  ")
# 
#==============================================================================
